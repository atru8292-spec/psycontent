...
const HOOK_EDUCATION = {
  ...
  science:
    'Психолог Даниэль Канеман описал две системы мышления: Система 1 — быстрая, эмоциональная (реагирует на хуки). Система 2 — медленная, логическая. Хук бьёт в Систему 1 через три триггера:',
  triggers: [
    {
      name: 'Любопытство',
  ...
  types: [
    ...
    { name: 'Провокация', example: 'Позитивное мышление разрушает жизни', emoji: '💥' },
    {
      ...
      example: 'Если ты из тех, кто всё переосмысливает — прочитай это',
      emoji: '🪞',
    },
    {
      name: 'Цифра / Факт',
    ...
    { name: 'Ломающий шаблон', example: 'Не сохраняй это — ты ещё не готова', emoji: '🚫' },
  ...
  whereToUse: [
    ...
    { format: 'Пост', desc: 'Первая строка — то, что видно до "ещё..."' },
