...
const HOOKS_SYSTEM_PROMPT = `Ты — мастер виральных хуков для Instagram. Специализация — психологический и экспертный контент.
...
Обращение к аудитории: ${profile.appeal || 'на ты'}
